...
class ConnectionPoolTest extends TestCase
{
    ...
    public function testPoolWithExternalDriver(): void
    {
        ...
        $externalConfig = new \JardisCore\DbConnection\Data\ExternalConfig($pdo);

        $pool = new ConnectionPool(
            writer: $externalConfig,
            readers: [],
            driverClass: \JardisCore\DbConnection\External::class
        );

        $writer = $pool->getWriter();
        $this->assertInstanceOf(\JardisCore\DbConnection\External::class, $writer);
